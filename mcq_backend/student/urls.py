...
from .views import UpcomingExamDetails,ExamQuestions,AttemptedDetails,PostResult,Checking,ExamResult,Results
urlpatterns = [
    ...
    path('results/<int:student_id>',Results.as_view(),name="results")
]