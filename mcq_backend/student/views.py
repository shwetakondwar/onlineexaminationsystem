...
from .serializers import UpcomingExamSerializers,ExamHostQuesSerializers,AttemptedExamSerializers,PostResultSerializers,CheckingSerializers,ResultsSerializers
...
class Results(generics.ListAPIView):
    ...
    def get_queryset(self,**kwargs):
        ...
        Results = Examdetails.objects.filter(student_id=student_id)
        return Results
