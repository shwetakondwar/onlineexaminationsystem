    ...
    return (
        <div className="row my-3">
            <div className="col-sm-2">
                <label style={{ fontSize: "24px", color: "black" }} htmlFor="staticEmail2" className="visually-hidden">{props.element.subname}</label>

            </div>
            <div className="col-sm-3">
                <label style={{ fontSize: "24px", color: "black" }} htmlFor="inputPassword2" className="visually-hidden">{props.element.year}-{props.element.stream}</label>

            </div>
            <div className="col-sm-3">
                <label style={{ fontSize: "24px", color: "black" }} htmlFor="inputPassword2" className="visually-hidden">{props.element.date}:---:{props.element.starttime}</label>
            ...
            <div className="col-sm-2">
                <button type="submit" onClick={handleSubmit} className="btn btn-primary">Finalize</button>
            </div>
